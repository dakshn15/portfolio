        ...
        <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
          <div className="w-full md:w-1/2 text-center md:text-start order-2 md:order-1">
            ...
            <span className="inline-block font-medium text-gray-300 mb-2">Frontend Developer</span>
              <h2 className='text-[26px] sm:text-3xl md:text-5xl lg:text-6xl font-bold mb-4'>I'm <span className="text-purple-500">Daksh Nimavat</span></h2>
          ...
          <div className="w-full md:w-1/2 order-1 md:order-2">
            <div className="relative mx-auto md:ml-auto md:mr-0 max-w-[350px] lg:max-w-[450px]">
              <div className="absolute inset-0 bg-purple-500 rounded-2xl blur-3xl opacity-20 -z-10 transform rotate-6"></div>
              <div className="img-ratio pt-[100%] rounded-2xl overflow-hidden shadow-2xl border-4 border-purple-500/20">
