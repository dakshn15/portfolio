            ...
            <div className="max-w-7xl mx-auto w-full px-4">
                <div className="flex md:flex-row flex-col-reverse items-center gap-6 lg:gap-14">
                    ...
                    <div className="flex-1 text-center md:text-start md:space-y-6 space-y-5">
                        <h2 className='text-[26px] sm:text-3xl lg:text-4xl'>About <span className='text-purple-500'>Me</span></h2>
                        <div>
                            <div className="flex items-start md:justify-start justify-center gap-4 mb-3">
                                <FaLaptopCode className="text-purple-500 md:text-xl text-base mt-0.5 flex-shrink-0" />
                        ...
                        <div>
                            <div className="flex items-start md:justify-start justify-center gap-4 mb-3">
                                <FaBookOpen className="text-purple-500 md:text-xl text-base mt-0.5 flex-shrink-0" />
